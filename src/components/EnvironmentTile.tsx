        ...
        <div className="space-y-4">
          ...
          <div className={`${aqiStyle.bg} backdrop-blur-sm border ${aqiStyle.ring}/30 rounded-xl p-6`}>
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className={`text-prose font-semibold ${aqiStyle.text}`}>{data.airQuality.label}</p>
                <p className="text-caption text-slate-400">European AQI</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2 text-center">
              <div>
                <p className="text-ui font-mono text-white">{data.airQuality.pm25.toFixed(1)}</p>
                <p className="text-caption text-slate-400">PM2.5 µg/m³</p>
              </div>
              <div>
                <p className="text-ui font-mono text-white">{data.airQuality.no2.toFixed(1)}</p>
