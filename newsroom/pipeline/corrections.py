...
WEEKLY_WRAP_BASIS = EditorialCorrection(
    ...
    description=(
        ...
        "article measures the price against is 2022-S2, four and a half years "
        "earlier, and the 24.7% it measures Lithuania's renewable share against "
        "is 2018 — the previous year, 2024, was 35.4%. Each figure quoted is a "
